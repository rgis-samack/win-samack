# ==============================================================================
#                      Antigravity WinUtil - Otimizador de Windows
# ==============================================================================
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="Antigravity WinUtil" Height="620" Width="880"
        ...
        <Grid>
            ...
            <Grid Grid.Row="0" x:Name="TitleBar" Background="#111827">
                ...
                <StackPanel Orientation="Horizontal" VerticalAlignment="Center" Margin="15,0,0,0">
                    ...
                    <TextBlock Text="Antigravity WinUtil" Foreground="#F8FAFC" FontSize="13" FontWeight="Bold"/>
            ...
            <Grid Grid.Row="1">
                ...
                <Border Grid.Column="0" Background="#0B0F19" BorderBrush="#1F2937" BorderThickness="0,0,1,0" Padding="8,15,8,15">
                    <Grid>
                        ...
                        <TextBlock Grid.Row="1" Text="Criado por Antigravity" Foreground="#475569" FontSize="11" HorizontalAlignment="Center" Margin="0,0,0,10"/>
                    </Grid>
                </Border>
...
function Action-CreateRestorePoint {
    ...
    try {
        ...
        # Cria o ponto
        Checkpoint-Computer -Description "Otimizacao Antigravity WinUtil" -RestorePointType "MODIFY_SETTINGS" -ErrorAction Stop
